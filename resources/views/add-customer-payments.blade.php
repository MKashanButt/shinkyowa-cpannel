    ...
    <div class="container">
        ...
        <form action="{{ $actionUrl }}" method="POST">
            ...
            <div class="item">
                ...
                <input type="text" name="stockId" id="stockId" required value="{{ isset($payment->stock_id) }}">
                <p id="stockid-find-message"></p>
            </div>
            <div class="item">
                <label for="cemail">Customer Email:</label>
                <input type="text" name="cemail" id="cemail" onblur="findEmail($('#cemail').val())" required
                    value="{{ isset($payment->customer_email) }}">
            ...
            <div class="item">
                ...
                <input type="text" name="payment" id="payment" required value="{{ isset($payment->payment) }}">
            </div>
            ...
            <div class="item" style="align-items: baseline">
                ...
                <textarea type="text" name="description" id="description" required rows="5">{{ isset($payment->description) }} </textarea>
            </div>
